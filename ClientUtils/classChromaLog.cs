    ...
    internal class classChromaLog
    {
        ...
        private static void addComponentLog(LogType f_LogType, string f_sFunction, string f_sMessage)
        {
            try
            {
                ...
                StreamWriter streamWriter = new StreamWriter(string.Concat(mSLogBasePath, "\\PPS_", now.ToString("yyyyMMddHH"), ".Log"), true);
                try
                {
        ...
        public static void deleteOldLog()
        {
            if (classChromaLog.LogThread != null)
            {
                classChromaLog.LogThread.deleteOldLog("PPS");
            }
            else
            {
                classChromaLog.deleteOldLog("PPS");
            }
        }
        ...
        {
            public const string m_sChromaLog = "PPS";
