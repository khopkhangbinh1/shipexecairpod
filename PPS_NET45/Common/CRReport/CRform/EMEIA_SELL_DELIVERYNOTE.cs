...
namespace CRReport.CRfrom
{
    public partial class EMEIA_SELL_DELIVERYNOTE
    {
        ...
        public void Initialize(string deliveryNo, string palletNo, bool print, string strPath)
        {
            ...
            //                                                                      round(SUM(COO_QTY) * FGWEIGHTKG, 2) AS TOTALNETWT,
            //                                                                      ItemText
            ...
            //                                                                GROUP BY LINEITEM, MPN, UPC, PRODESC, FGWEIGHTKG, ItemText, COO
            ...
            //                                             AND TOI.DELIVERY_NO = T9U.DELIVERYNO
            //                                             AND TOI.DELIVERY_NO = '{0}') T
            //                                   GROUP BY LINEITEM, MPN, UPC, PRODESC, FGWEIGHTKG, ItemText ,ICTPN ORDER BY LINEITEM ASC", deliveryNo);
