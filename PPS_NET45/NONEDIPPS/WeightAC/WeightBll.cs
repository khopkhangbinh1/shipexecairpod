...
namespace WeightAC
{
    public class WeightBll
    {
        ...
        {
            WeightDal wd = new WeightDal();
            return wd.GetPalletUnitInfo(strPalletNo);
        }
        ...
        {
            WeightDal wd = new WeightDal();
            return wd.GetShippingMarkAppleCareInfo(strPalletNo);
        }

        public bool checkIsPrint(DataTable dt, out string msg)
        {
            msg = string.Empty;
            int f_count = 0;
            ...
            {
                string city = dt.Rows[i]["SHIPTOCITY"].ToString().ToUpper();
        ...
        {
            WeightDal wd = new WeightDal();
            return wd.getShippingInfoByPalletNo(strPalletNo);
        }

        public string calculateShiptoORReturnTo(params string[] arrSort)
        {
            string temp = "";
