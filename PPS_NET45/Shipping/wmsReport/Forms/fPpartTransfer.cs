...
namespace wmsReport
{
    public partial class fPpartTransfer : Form
    {
        ...
        private void initLocationFrom()
        {
            ...
            {
                cmbLocationFrom.Items.Add(dt.Rows[i]["id"]);
            }
        ...
        private void initLocationTo()
        {
            ...
            //for (int i = 0; i < dt.Rows.Count; i++)
            //{
            //    cmbLocationTo.Items.Add(dt.Rows[i]["id"]);
            //}
        }
        ...
        private void txtSN_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (rdoLockTo.Checked == true)
            {
                ...
                if (strResult.Equals("OK"))
                {
                    ...
                    //strResult2 = "OK";
                    string locationFrom = cmbLocationFrom.Text;

                    if (strResult2.Equals("OK"))
                    {
                       // dgvFindResultTo.Rows.Clear();
                        wb.ShowStockInfo2(cmbLocationTo.Text, dgvFindResultTo, strCSN);
                        LibHelper.MediasHelper.PlaySoundAsyncByOk();
                        ShowMsg("OK", -1);
                        if (thread!=null)
                        ...
                        //dgvFindResultFrom.Rows.Clear();
                        thread = new System.Threading.Thread(new System.Threading.ThreadStart(() =>
                       {
                           wb.ShowStockInfo2(locationFrom, dgvFindResultFrom, strCSN);
                          }));
