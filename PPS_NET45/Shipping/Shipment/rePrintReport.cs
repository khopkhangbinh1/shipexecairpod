            ...
            if (e.KeyCode == Keys.Enter || e.KeyCode == Keys.Tab)
            {
                ...
                if (remainNum == 0)
                {
                    ...
                    try
                    {
                        ...
                        cr.HanDoveMan2(strShipmentID, strPackPalletNo, true, false, "", "", "");
                        ClientUtils.WritePrintLabelLog("Loading Truck Manifest", "", strPackPalletNo, LocalHelper.getMacAddr_Local());
                    }
                    catch (Exception ex)
                    {
